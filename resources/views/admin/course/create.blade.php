                ...
                <form action="{{URL::route('courses.store')}}{{isset($course) ? '?action=edit' : ''}}" method="post"
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <textarea id="elm1" name="description">{!! $course->description ?? '' !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <div class="">
                                <input id="input-date1" name="duration" class="form-control input-mask"
                                    data-inputmask="'mask': '99:99'" required value="{{$course->duration ?? ''}}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="input-date1" name="date" class="form-control input-mask"
                                value="{{$course->start_date ?? ''}}" data-inputmask="'alias': 'datetime'"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-multiple" name="teachers" required>
                                    ...
                                    <option value="{{$item->id}}"
                                        {{isset($course) && $course->teachers->contains($item->id) ? 'selected' : ''}}>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="cash_type" id="cash_type">
                                <option value="free" {{isset($course) && $course->cach == 'free' ? 'selected' : ''}}>
                                    رایگان</option>
                                <option value="cash" {{isset($course) && $course->cach == 'money' ? 'selected' : ''}}>
                                    غیررایگان</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="public_type" id="public_type">
                                <option value="public" {{isset($course) && $course->private == 0 ? 'selected' : ''}}>
                                    عمومی</option>
                                <option value="private" {{isset($course) && $course->private == 1 ? 'selected' : ''}}>
                                    اختصاصی</option>
                            </select>
                        </div>
                        {{-- <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="group">
                                    ...
                                    <option value="{{$item->id}}"
                                        {{isset($course) && $course->group_id == $item->id ? 'selected' : ''}}>
                                        {{$item->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="quiz">
                                    ...
                                    <option value="{{$item->id}}"
                                        {{isset($course) && $course->quiz->id == $item->id ? 'selected' : ''}}>
                                        {{$item->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 select2-multiple" multiple="multiple"
                                    ...
                                    <option value="{{$item->id}}"
                                        {{isset($course) && $course->prerequisites->contains($item->id) ? 'selected' : ''}}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 enable-tag select2-multiple" multiple="multiple"
                                    ...
                                    <option value="{{$item->tagname}}"
                                        {{isset($course) && $course->tags->contains($item->id) ? 'selected' : ''}}>
                                        {{$item->tagname}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 enable-tag" name="category" required>
                                    ...
                                    <option value="{{$item->title}}"
                                        {{isset($course) && $course->category_id == $item->id ? 'selected' : ''}}>
                                        {{$item->title}}</option>
                                    @endforeach
                                </select>
                            </div>
